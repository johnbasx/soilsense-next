...
const OurAppsSteps = () => {
  ...
  const Tapps = t('our-apps-steps.apps', {
    returnObjects: true,
  })
  return (
    <Container>
        ...
        <div className="relative grid gap-8 row-gap-5 mb-8 md:row-gap-8 lg:grid-cols-3 sm:grid-cols-2">
          ...
          {ourAppsStepsData.map((data, idx) => (
            <div
              ...
              className="p-5 overflow-hidden duration-300 transform bg-white border shadow-sm rounded-2xl hover:-translate-y-2"
            >
