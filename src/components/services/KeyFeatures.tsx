...
const KeyFeatures = () => {
  ...
  const Tfeatures = t('key-features.blocks', { returnObjects: true })
            ...
            >
              <div className="flex flex-col items-start justify-start order-last h-full">
                <h1 className="mb-3 text-lg font-semibold text-gray-900 leading-1 md:text-lg">
                  {/* {item.name} */}
                  {Tfeatures[index].name}
                </h1>
                <p className="mb-3 leading-relaxed line-clamp-1 md:line-clamp-3">
                  {/* {item.about} */}
                  {Tfeatures[index].about}
                </p>
                <div className="flex flex-wrap items-center ">
                  <Link
                    href="#!"
                    className="inline-flex items-center gap-2 font-semibold text-primary-500 md:mb-2 lg:mb-0"
                  >
                    {/* Know More */}
                    {t('key-features.know-more')}
                    <TbArrowRight />
                  </Link>
                </div>
              </div>
